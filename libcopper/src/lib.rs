...
enum Conversion {
	Mul { mul_token: kw::mul, by: TokenTree },
	Div { div_token: kw::div, by: TokenTree },
	Add { add_token: kw::add, by: TokenTree },
	Sub { sub_token: kw::sub, by: TokenTree },
	Fun { fun_token: kw::fun, paren_token: token::Paren, fun: TokenStream },
}
